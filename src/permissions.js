...
for(const r of ['Governante','Capo Governante']){fallback[r].home=allow('view');fallback[r].issues=allow('view','create');fallback[r].housekeeping=allow('view','edit','complete');fallback[r].notifications=allow('view');fallback[r].supplies=allow('view','create');fallback[r].urgent=allow('view');fallback[r].reminders=allow('view')}
