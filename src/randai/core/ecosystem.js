...
const MODULES = Object.freeze([
  ...
  { id:'randarchitecture', name:'RandArchitecture', status:EcosystemStatus.BACKEND_ONLY, phase:'KNOWLEDGE', evidence:['src/randai/architecture/catalog.js','src/randai/architecture/advisor.js','test/randarchitecture-block3.test.js'], description:'Advisor architetturale evidence-based: traduce pattern di system design in KEEP/EVALUATE senza auto-provisioning, runtime esterni o secondi proprietari canonici.' },
