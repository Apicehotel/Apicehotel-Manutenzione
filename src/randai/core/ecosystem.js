...
const MODULES = Object.freeze([
  ...
  { id:'randai', name:'RandAI', status:EcosystemStatus.LIVE, phase:'AI', evidence:['src/randai/RandAIAssistant.jsx','src/randai/auth/RandAIProtectedRoute.jsx','src/randai/runtime/hitl-runtime.js','src/randai/runtime/risk-policy.js','src/randai/runtime/sandbox.js','test/randai-group7-hitl-runtime.test.js'], description:'Assistente e runtime AI governato con risk policy canonica, HITL fail-closed e sandbox senza unrestricted host execution.' },
  { id:'randcore', name:'RandCore', status:EcosystemStatus.LIVE, phase:'CORE', evidence:['src/randai/core/orchestrator.js','src/randai/core/health-snapshot.js','src/randai/core/randcore-runtime.js','src/randai/core/governance-runtime.js','src/randai/core/supabase-governance-store.js','src/randai/action-gateway.js','src/reliability/release-gate.js'], description:'Contratti, runtime, governance, rules/audit/doctor/security decision layer e health canonici; non sostituisce RLS/RPC/Action Gateway.' },
  ...
  { id:'randmind', name:'RandMind', status:EcosystemStatus.LIVE, phase:'KNOWLEDGE', evidence:['src/randai/memory/randmind.js','src/randai/memory/engine.js','src/randai/memory/evidence.js','src/randai/memory/store.js','src/randai/memory/production-gate.js','src/randai/control/RandMindConsole.jsx','supabase/migrations/20260903223000_randmind_live_81_86.sql','supabase/migrations/20260912130000_randmind_v2.sql','test/randai-block23-randmind-81-86.test.js','test/randai-group5-randmind-v2.test.js'], description:'Memoria canonica governata: provenienza audit verificata, recall temporale as-of, confidence, conflitti governati, supersession timestamped, retention non distruttiva e forgetting auditabile hotel-scoped.' },
  { id:'randresearch', name:'RandResearch', status:EcosystemStatus.LIVE, phase:'KNOWLEDGE', evidence:['src/randai/research/runtime.js','src/randai/research/coordinator.js','src/randai/research/store.js','supabase/migrations/20260912143000_randresearch_v1.sql','test/randai-group6-randresearch.test.js'], description:'Owner canonico della ricerca approfondita: livelli L0-L4, query canonica, provenance/source scoring, contraddizioni, gap, persistence e ship gate fail-closed; riusa RandKnowledge/RandMind/RandCore.' },
  ...
  { id:'reporadar', name:'Repo Radar', status:EcosystemStatus.LIVE, phase:'DISCOVERY', evidence:['src/randai/discovery/engine.js','src/randai/discovery/repo-radar.js','src/randai/discovery/repo-radar-sources.js','src/randai/control/RepoRadarConsole.jsx','.github/workflows/repo-radar.yml'], description:'Scouting settimanale multisorgente, discovery di nuove candidate, valutazione profonda e adozione governata senza auto-install.' },
  ...
  { id:'randdesign', name:'RandDesignBridge', status:EcosystemStatus.PARTIAL, phase:'EXPERIENCE', evidence:['src/randai/design/rand-design-bridge.js','scripts/rand-design-bridge-check.mjs','test/randdesign-bridge-v1.test.js','docs/architecture/RANDDESIGNBRIDGE_V1.md'], description:'Bridge governato Figma↔RandUI: MCP ufficiale primario, context/token/code mapping opzionali e visual regression senza creare un secondo design system.' },
