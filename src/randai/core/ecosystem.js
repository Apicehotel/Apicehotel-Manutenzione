...
const MODULES = Object.freeze([
  ...
  { id:'reporadar', name:'Repo Radar', status:EcosystemStatus.PARTIAL, phase:'DISCOVERY', evidence:['src/randai/discovery/engine.js','src/randai/discovery/store.js'], description:'Discovery engine presente; scouting e benchmark 360° da productizzare.' },
