...
const tone = (status) => status === 'HEALTHY' || status === 'STABLE' ? 'good' : status === 'CRITICAL' ? 'bad' : status === 'DEGRADED' || status === 'EVOLVING' ? 'warn' : ''
