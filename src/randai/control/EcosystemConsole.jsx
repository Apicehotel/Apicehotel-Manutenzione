...
const OPEN_TARGETS={randguide:'knowledge',randmind:'knowledge',randbrain:'dashboard',randcontrol:'dashboard',randapp:'dashboard',warehouse:'issues'}

export default function EcosystemConsole({accessHotels=[],hotelFilter='all',onOpenModule}){
