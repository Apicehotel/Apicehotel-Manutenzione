...
const RULES = [
  ...
  { category: 'import', label: 'File / importazione', test: /xls|xlsx|spreadsheet|workbook|housekeeping import|importazione|file upload|allegato|parser|foglio/i, guidance: 'Controlla che il file sia quello previsto e non sia vuoto o danneggiato; nessun dato parziale deve essere considerato valido.' },
