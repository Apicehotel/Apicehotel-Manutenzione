...
import { fetchNotificationInbox, markAllNotificationsRead, markNotificationRead, subscribeNotificationInbox } from './notification-inbox-data.js'
import './notification-inbox.css'

const fmt = (value) => {
  if (!value) return ''
  try { return new Intl.DateTimeFormat('it-IT', { day:'2-digit', month:'short', hour:'2-digit', minute:'2-digit' }).format(new Date(value)) } catch { return '' }
}
