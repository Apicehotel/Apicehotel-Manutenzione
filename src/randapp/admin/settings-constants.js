...
export const PERMISSION_GROUPS = [
  ...
  { id:'system', label:'Amministrazione', modules:[['users','Utenti'],['role_permissions','Ruoli e permessi'],['app_settings','Impostazioni app'],['sensors','Sensori'],['usage','Consumi'],['diagnostics','Diagnostica']] },
]
