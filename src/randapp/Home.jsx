...
const HOME_STYLES = `
  ...
  .rs-widget-card{position:relative;border-radius:clamp(15px,2vw,20px)!important}.rs-widget-panel-title{position:absolute;top:14px;left:12px;font-size:.78rem;font-weight:800;line-height:1;color:var(--rs-text);white-space:nowrap}.is-editing .rs-widget-panel-title{top:50px}
  ...
  .rs-widget-weather{display:flex;flex-direction:column;align-items:center;justify-content:center;gap:7px;text-align:center!important;padding:36px 12px 12px!important}.rs-widget-weather__icon{font-size:2rem;line-height:1}.rs-widget-weather strong{font-size:clamp(.78rem,2vw,1rem)}.rs-widget-weather>span:not(.rs-widget-weather__icon){font-size:.72rem;color:var(--rs-text-2);line-height:1.2}.rs-widget-weather__hint{display:flex;align-items:center;gap:5px}.rs-widget-weather--warning{box-shadow:inset 0 0 0 1px rgba(245,158,11,.55)}.rs-widget-weather--danger{box-shadow:inset 0 0 0 2px rgba(239,68,68,.7)}.rs-widget-weather--muted{opacity:.82}
  .rs-widget-quick{display:flex;flex-direction:column;justify-content:center;gap:9px;padding:36px 12px 12px!important}.rs-widget-quick__title{font-size:.9rem}.rs-widget-quick__actions{display:grid;gap:7px}.rs-widget-quick__actions--s{grid-template-columns:repeat(3,1fr)}.rs-widget-quick__actions--m{grid-template-columns:repeat(3,minmax(0,1fr))}.rs-widget-quick__actions--l{grid-template-columns:repeat(3,minmax(0,1fr))}
  ...
  .is-editing .rs-widget-weather,.is-editing .rs-widget-quick{padding-top:66px!important}.is-editing .rs-widget-weather{gap:4px}.is-editing .rs-widget-weather__icon{font-size:1.75rem}.rs-home-activity{margin-top:clamp(14px,2.4vw,22px)}.rs-home-recent{width:100%;border:0;background:transparent;color:inherit;text-align:left}
  @media(max-width:520px){.rs-widget-home .rs-hero{margin-bottom:14px}.rs-widget-grid-shell{margin-inline:0;width:100%}.rs-widget-stat{column-gap:6px}.rs-widget-quick__actions button{font-size:.68rem}.rs-widget-card--m .rs-widget-quick__actions button span{max-width:64px;overflow:hidden;text-overflow:ellipsis}.rs-widget-editbar{left:4px;right:4px}}
`
