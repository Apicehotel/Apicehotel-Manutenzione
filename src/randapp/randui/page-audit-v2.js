...
export const RANDUI_PAGE_AUDIT_V2 = Object.freeze({
  ...
  task: audit('unify','high',['hub mobile stabile per promemoria e avvisi','stessa gerarchia visiva di Planning e Operatività']),
  'my-work': audit('unify','high',['vista personale lavori distinta dal Task hub','ottimizzare densità operativa']),
