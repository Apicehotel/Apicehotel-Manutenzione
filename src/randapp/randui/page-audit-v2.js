...
export const RANDUI_PAGE_AUDIT_V2 = Object.freeze({
  ...
  supplies: audit('unify','medium',['cache e boundary online-write preservati','pagina nav dedicata con PageTitle + rs-ops-surface','niente launcher flottante globale']),
  ...
  randai: audit('unify','medium',['pagina chat dedicata nella shell (tab + header)','Control Center /randai resta URL protetta separata','niente popup overlay come destinazione primaria']),
})
