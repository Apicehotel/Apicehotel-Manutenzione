-- Block 31 follow-up: align operational-learning confidence with the existing memory contract.
...
begin
  ...
  insert into public.randai_memory(
    ...
    case when v_task.id is not null and jsonb_array_length(v_steps) > 0 then 'confirmed' else 'probable' end,
