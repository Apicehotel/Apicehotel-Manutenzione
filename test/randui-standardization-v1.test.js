...
test('RandUI keeps v1 stable while standardization is independently versioned', async () => {
  const contract = await read('src/randapp/randui/standardization-contract.js')
