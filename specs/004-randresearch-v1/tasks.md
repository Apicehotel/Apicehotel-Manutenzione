...
- [DOING] T007 Integrare package/README/architecture/ecosystem. Evidence: `package.json`, `README.md`, `docs/architecture/RANDRESEARCH_V1.md`, `src/randai/core/ecosystem.js`
- [TODO] T008 Zombie/overlap check finale. Evidence: `specs/004-randresearch-v1/plan.md`
- [TODO] T009 CI completa verde. Evidence: PR Point 5
- [TODO] T010 Converge ready-for-human-review. Evidence: PR Point 5
