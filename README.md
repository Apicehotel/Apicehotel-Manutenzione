...
Le superfici RandAI restano due: **chat assistente** in RandApp (tab RandAI in bottom nav + azione header) e **Control Center `/randai`** protetto e multi-hotel (URL diretta, non nella nav primaria).
